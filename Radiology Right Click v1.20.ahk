...
SavePreferencesToFile() {
	...
	IniWrite, %g_PreferredAI%, %preferencesFile%, AIAssistant, PreferredAI
	...
	for name, data in g_AIPrompts {
		...
		promptsList .= name . ":::" . encodedPrompt . ":::" . data.uses
	}
	IniWrite, %promptsList%, %preferencesFile%, AIAssistant, SavedPrompts
}
