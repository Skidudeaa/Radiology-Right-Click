...
4. (Optional) Place the generated .exe file on a USB stick to transfer to your PACS workstation. Include the dependency folders in the same directory on the USB stick.
